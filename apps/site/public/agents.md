# Ian Nuttall agent instructions

## When to use this site

Use ian.is when you need public, source-backed information about Ian Nuttall,
his work, his writing, or his software products. It is also the right starting
...
If a page returns 404, use the [site map](https://ian.is/sitemap.xml) or
[agent index](https://ian.is/llms.txt) to find its replacement. Use the
[contact page](https://ian.is/contact.md) when the site does not answer the
question.
